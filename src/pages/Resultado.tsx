...
import { CheckCircle2, Award, Star, ShoppingBag, ArrowRight } from "lucide-react";
    ...
    <div className="quiz-container">
      ...
      >
        ...
        <motion.h2
          ...
          className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground mb-2 sm:mb-3 text-center"
        >
        ...
        {/* Oferta do Boné - Apenas para quem votou Flávio */}
        {votedForFlavio && (
          <motion.div
            initial={{ y: 20, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ delay: 0.4 }}
            className="w-full bg-gradient-to-br from-secondary/10 via-accent/5 to-secondary/10 border-2 border-secondary/30 rounded-2xl p-4 sm:p-6 mb-4 sm:mb-6 max-w-sm"
          >
            ...
            <h3 className="text-base sm:text-lg font-bold text-foreground mb-2 text-center">
